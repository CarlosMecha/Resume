...
\experience
  ...
  {Segment, San Francisco, CA, United States}
  {Software Engineer}
  {\vspace{-1em}\begin{rlist}
    \item DRI of a small team focused on improving our testing and deployment processes.
    ...
    \item Helping to maintain Segment's massive AWS infrastructure (+6000 ECS tasks, +1.8PB of S3 data,
    +350 production databases, +1000 EC2 instances).
